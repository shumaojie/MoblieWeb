 <?php
	...
	$types=$this->getTypes();
	$kjdTime=$types[$this->type]['data_ftime'];//开奖前停止下注时间 120S
    //$actionNo['actionTime'] //开奖时间 00:06:30
    ...
    <div class="bd" id="kaijiang" type="<?=$this->type?>" ctype="<?=$types[$this->type]['type']?>"></div>
     <div class="thisGame">
       ...
       <td width="420" class="game_top_aright"> 
	    <div class="kj-bottom">
            <span class="tit">
                <span class='gamename'><?=$types[$this->type]['title']?></span>&nbsp;&nbsp;第 <span class="last_issues"><b><?=$lastNo['actionNo']?></span></b> 期  总共:<b style="color:#FF0000"><?=$types[$this->type]['num']?></b>&nbsp;期
                <span id="kjsay">开奖倒计时：<em class="kjtips">00:00</em></span>
            </span>
            <img id="voice" class="voice-on"  title="声音开启，点击关闭" onclick="voiceKJ()">
            <span id="lockgame"></span>
            <div class="clear"></div>
        </div>
...
$(function(){
	...
	window.kjTime=parseInt(<?=json_encode($kjdTime)?>);//停止下注时间
